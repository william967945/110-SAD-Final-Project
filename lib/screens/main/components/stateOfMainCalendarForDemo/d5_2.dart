...
class DifferentStateOfCalendar52 extends StatelessWidget {
  const DifferentStateOfCalendar52({
    Key? key,
  }) : super(key: key);
    ...
    return Expanded(
      child: GridView.count(
        ...
        children: const <Widget>[
          ...
          UnitDateSquare(color: c8, date: ""), // 1
          UnitDateSquare(color: secondaryColor, date: ""),
          UnitDateSquare(color: secondaryColor, date: ""),
          UnitDateSquare(
            color: secondaryColor,
